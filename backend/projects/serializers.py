...
@extend_schema_serializer(
    examples=[
        OpenApiExample(
            ...
            value={
                'id': 1,
                'image': 'https://api.atonixcorp.com/media/projects/gallery/screenshot1.jpg',
    ...
    examples=[
        OpenApiExample(
            ...
            value={
                ...
                'image': 'https://api.atonixcorp.com/media/projects/analytics-platform.jpg',
                'technologies': ['React', 'Django', 'PostgreSQL', 'Redis', 'Docker'],
                'status': 'active',
                'website_url': 'https://analytics.atonixcorp.com',
                'github_url': 'https://github.com/atonixcorp/analytics-platform',
                'documentation_url': 'https://docs.analytics.atonixcorp.com',
                'is_featured': True,
