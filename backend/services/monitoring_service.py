...
def get_overview_stats(owner) -> dict:
    ...
    from .monitoring_models import Incident, MonitoringAlert, AlertRule
...
def ingest_metric(owner, resource_id: str, service: str,
    ...
    from .monitoring_models import MetricSnapshot
...
def _evaluate_rules(owner, resource_id, service, metric, value):
    ...
    from .monitoring_models import AlertRule, MonitoringAlert
    from django.utils import timezone
...
def create_incident(owner, service: str, severity: str, title: str,
    ...
    """Open a new incident."""
    from .monitoring_models import Incident, IncidentUpdate
...
def update_incident_status(incident, new_status: str, message: str, author) -> dict:
    ...
    from .monitoring_models import IncidentUpdate
    from django.utils import timezone
