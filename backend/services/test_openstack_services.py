...
CONN_PATH = "services.openstack_compute.get_connection"
...
class TestOpenStackCompute(unittest.TestCase):
    ...
    def test_list_servers(self, mock_get_conn):
        ...
        from services.openstack_compute import list_servers
        result = list_servers()
    ...
    def test_get_server_found(self, mock_get_conn):
        ...
        from services.openstack_compute import get_server
    ...
    def test_create_server(self, mock_get_conn):
        ...
        from services.openstack_compute import create_server
    ...
    def test_delete_server(self, mock_get_conn):
        ...
        from services.openstack_compute import delete_server
    ...
    def test_list_flavors(self, mock_get_conn):
        ...
        from services.openstack_compute import list_flavors
        result = list_flavors()
        self.assertEqual(len(result), 2)
...
NET_CONN_PATH = "services.openstack_network.get_connection"
...
class TestOpenStackNetwork(unittest.TestCase):
    ...
    def test_list_networks(self, mock_get_conn):
        ...
        from services.openstack_network import list_networks
    ...
    def test_create_network(self, mock_get_conn):
        ...
        from services.openstack_network import create_network
    ...
    def test_delete_network(self, mock_get_conn):
        ...
        from services.openstack_network import delete_network
    ...
    def test_list_security_groups(self, mock_get_conn):
        ...
        from services.openstack_network import list_security_groups
    ...
    def test_list_floating_ips(self, mock_get_conn):
        ...
        from services.openstack_network import list_floating_ips
...
VOL_CONN_PATH = "services.openstack_volume.get_connection"
...
class TestOpenStackVolume(unittest.TestCase):
    ...
    def test_list_volumes(self, mock_get_conn):
        ...
        from services.openstack_volume import list_volumes
        result = list_volumes()
        self.assertEqual(len(result), 1)
    ...
    def test_get_volume_found(self, mock_get_conn):
        ...
        from services.openstack_volume import get_volume
    ...
    def test_create_volume(self, mock_get_conn):
        ...
        from services.openstack_volume import create_volume
    ...
    def test_delete_volume(self, mock_get_conn):
        ...
        from services.openstack_volume import delete_volume
    ...
    def test_list_snapshots(self, mock_get_conn):
        ...
        from services.openstack_volume import list_snapshots
...
class TestOpenStackViews(unittest.TestCase):
    ...
    @patch("services.openstack_views.is_openstack_configured", return_value=False)
    @patch("services.openstack_views.osc")
    def test_cloud_status_unconfigured(self, mock_osc, mock_is_configured):
        from rest_framework.test import APIRequestFactory
        from services.openstack_views import cloud_status
