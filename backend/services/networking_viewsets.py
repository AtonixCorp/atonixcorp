...
from .openstack_load_balancer import provision_load_balancer, delete_load_balancer, load_balancer_metrics
from .openstack_cdn import provision_cdn_distribution, delete_cdn_distribution, cdn_distribution_metrics
...
class LoadBalancerViewSet(viewsets.ModelViewSet):
    ...
    def add_target_group(self, request, pk=None):
        """Create target group."""
        from .networking_serializers import TargetGroupCreateSerializer, TargetGroupDetailSerializer
        lb = self.get_object()
