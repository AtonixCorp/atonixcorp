    ...
    MuiCssBaseline: {
      styleOverrides: {
        ':root': {
          ...
          '--color-text-secondary': '#A0A8B5',
          '--color-border': '#2a4d69',
          '--color-surface': '#183042',
          '--dashboard-background': '#183042',
          '--dashboard-surface': '#1e3a50',
          '--dashboard-surface-subtle': '#224460',
          '--dashboard-surface-hover': '#2a4d69',
          '--dashboard-border': '#2a4d69',
          '--dashboard-border-strong': '#3a6080',
