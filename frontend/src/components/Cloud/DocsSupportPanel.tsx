          ...
          <Grid size={{ xs: 12, sm: 6, md: 4 }} key={link.title}>
            ...
            >
              <Stack direction="row" alignItems="center" spacing={1.25} mb={1}>
                <Box
                  sx={{
                    ...
                    bgcolor: 'rgba(20,184,166,.1)', color: '#14b8a6',
              ...
              <Stack direction="row" alignItems="center" spacing={.5} mt={1.5}>
                <Typography variant="caption" sx={{ color: '#14b8a6', fontWeight: 600, fontSize: '.75rem' }}>
                  Read more
                </Typography>
                <ArrowForwardIcon sx={{ color: '#14b8a6', fontSize: '.85rem' }} />
              </Stack>
            </Box>
          </Grid>
        ))}
