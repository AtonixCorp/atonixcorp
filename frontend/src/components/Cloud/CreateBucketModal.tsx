// AtonixCorp Cloud – Create Bucket wizard modal (3 steps)
...
const CreateBucketModal: React.FC<Props> = ({ open, onClose, onCreated }) => {
  ...
  const Step3 = (
    <Stack spacing={2}>
      ...
      <Alert severity="info" sx={{ bgcolor: isDark ? '#0D2137' : '#EFF6FF', color: isDark ? '#93c4f0' : '#1d4ed8', border: `1px solid ${t.border}`, fontSize: 12 }}>
