    ...
    columns: [
      {
        ...
        links: [
          { label: 'High-Performance Compute', path: '/features' },
          { label: 'GPU-Accelerated Servers', path: '/features' },
          { label: 'Storage-Optimized Servers', path: '/features' },
          { label: 'Network-Optimized Servers', path: '/features' },
          { label: 'Dedicated AI Nodes', path: '/features' },
        ],
      },
      {
        title: 'VPS',
        links: [
          { label: 'General Purpose VPS', path: '/features' },
          { label: 'Compute-Optimized VPS', path: '/features' },
          { label: 'Memory-Optimized VPS', path: '/features' },
          { label: 'GPU VPS', path: '/features' },
          { label: 'Container-Ready VPS', path: '/features' },
        ],
      },
      {
        title: 'Quick Access',
        links: [
          { label: 'Compare Server Types', path: '/features' },
          { label: 'Pricing', path: '/features' },
          { label: 'Availability by Region', path: '/docs' },
          { label: 'Documentation', path: '/docs' },
        ],
      },
    ],
