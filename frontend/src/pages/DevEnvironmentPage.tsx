...
const ENVS: Env[] = [
  ...
  {
    id: 'dev', label: 'Development', color: '#153d75', bg: 'rgba(21,61,117,.10)', protected: false,
            ...
            <TableBody>
              {env.routes.map(r => (
                <TableRow key={r.path} sx={{ '& td': { borderColor: t.border } }}>
                  ...
                  <TableCell sx={{ py: 0.75 }}>
                    <Chip label={r.method} size="small" sx={{ height: 18, fontSize: '.66rem', fontWeight: 700, bgcolor: 'rgba(21,61,117,.1)', color: S.info, '& .MuiChip-label': { px: 0.7 } }} />
                  </TableCell>
                  <TableCell sx={{ py: 0.75 }}>
                ...
                {env.secrets.map(sec => (
                  <React.Fragment key={sec.name}>
                    ...
                    {expandRotation[sec.name] && sec.rotationHistory?.map((r, ri) => (
                      <TableRow key={ri} sx={{ '& td': { borderColor: t.border, bgcolor: 'rgba(21,61,117,.03)' } }}>
                  ...
                  return (
                    <React.Fragment key={key}>
                        ...
                        <TableCell sx={{ py: 0.7 }}>
                          {sec.rotationHistory && (
                            <Chip
                              ...
                              sx={{ height: 18, fontSize: '.62rem', fontWeight: 700, cursor: 'pointer', bgcolor: 'rgba(21,61,117,.08)', color: S.info, '& .MuiChip-label': { px: 0.6 } }}
                            />
                          )}
                        </TableCell>
                      ...
                      {expandRot[key] && sec.rotationHistory?.map((r, ri) => (
                        <TableRow key={ri} sx={{ '& td': { borderColor: t.border, bgcolor: 'rgba(21,61,117,.025)' } }}>
...
const ENV_TYPE_OPTIONS = [
  { value: 'development', label: 'Development', color: '#153d75', bg: 'rgba(21,61,117,.12)' },
          ...
          {[
            ...
            <Box
              ...
              sx={{
                ...
                bgcolor: form.multiMode === mode.value ? 'rgba(21,61,117,.08)' : 'transparent',
              }}
            >
      ...
      {form.multiMode && (
        <Box>
          ...
          {form.envTypes.length > 0 && (
            <Box sx={{ mt: 1.5, px: 1.25, py: 0.75, borderRadius: '6px', bgcolor: 'rgba(21,61,117,.06)', border: `1px solid rgba(21,61,117,.2)` }}>
