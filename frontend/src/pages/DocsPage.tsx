...
const serviceGroups: ServiceGroup[] = [
  ...
  },
  {
    ...
    services: [
      { name: 'Deployments', route: '/developer/Dashboard/deployments', summary: 'Application deployment flows, release tracking, and rollout controls.' },
      { name: 'CI/CD Pipelines', route: '/developer/Dashboard/cicd', summary: 'Build pipelines, automation steps, environments, and approvals.' },
      { name: 'Containers', route: '/developer/Dashboard/containers', summary: 'Container lifecycle, image management, and vulnerability scanning.' },
      { name: 'Kubernetes', route: '/developer/Dashboard/kubernetes', summary: 'Cluster health, nodes, workloads, and namespace management.' },
      { name: 'Developer Monitoring', route: '/developer/Dashboard/monitoring', summary: 'Logs, metrics, traces, and alerting for workloads.' },
      { name: 'API Management', route: '/developer/Dashboard/api-management', summary: 'API publication, policies, versioning, and access governance.' },
      { name: 'Resource Control', route: '/developer/Dashboard/resource-control', summary: 'Quota management, capacity controls, and resource policy limits.' },
      { name: 'My Workspace', route: '/developer/Dashboard/workspace', summary: 'Workspace setup, preferences, and developer environment controls.' },
    ],
  },
  {
