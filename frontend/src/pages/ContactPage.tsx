    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const mockContacts: ContactPerson[] = [
          {
            ...
            department: 'Technology',
                email: 'john.smith@atonixcorp.com',
          ...
          },
          {
            ...
            department: 'Engineering',
                email: 'sarah.johnson@atonixcorp.com',
          ...
          },
          {
            ...
            phone: '+27 678 654 624',
            bio: 'Socials — GitHub: https://github.com/atonixdev • LinkedIn: https://linkedin.com/in/atonixdev • Facebook: https://facebook.com/atonixdev • X: https://x.com/atonixdev',
            linkedin_url: 'https://linkedin.com/in/atonixdev',
            is_primary: false,
            is_active: true,
            order: 3,
            avatar: undefined,
        ...
        const mockOffices: OfficeLocation[] = [
          ...
          {
            id: 3,
            name: 'Cape Town Office (provisional)',
            address_line_1: 'Suite 200, 1 Signal Hill Road',
            address_line_2: '',
            city: 'Cape Town',
            state: '',
            postal_code: '8001',
            ...
            email: 'cape-town@atonixcorp.com',
            latitude: -33.9249,
            longitude: 18.4241,
            is_headquarters: false,
            is_active: true,
          ...
          {
            id: 4,
            name: 'Johannesburg Office (provisional)',
            address_line_1: 'Level 3, 10 Freedom Tower',
            address_line_2: '',
            city: 'Johannesburg',
            state: '',
            postal_code: '2001',
            ...
            email: 'johannesburg@atonixcorp.com',
            latitude: -26.2041,
            longitude: 28.0473,
            is_headquarters: false,
            is_active: true,
