  ...
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: t.background, p: { xs: 2, md: 3 } }}>
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 2 }}>
        <Typography sx={{ fontSize: '1.1rem', fontWeight: 800, color: t.textPrimary }}>Pipelines</Typography>
      ...
      <Box sx={{ bgcolor: t.surface, border: `1px solid ${t.border}`, borderRadius: 2, p: 3 }}>
        <Typography sx={{ color: t.textPrimary, fontWeight: 700, mb: 1 }}>Pipeline run integration pending</Typography>
        <Typography sx={{ color: t.textSecondary, fontSize: '.9rem' }}>
          Mock pipeline runs were removed. Connect this page to CI/CD pipeline APIs for live execution and status.
        </Typography>
      </Box>
    </Box>
  );
