// AtonixCorp Cloud — Team Detail Page (7 tabs)
...
function PortfoliosTab({ team, reload }: { team: Team; reload: () => void }) {
  ...
  const PORT_TYPE_COLOR: Record<PortfolioType, string> = {
    developer: '#008080', marketing: '#A855F7', data: '#22C55E', general: '#6B7280',
  };
...
const AVATAR_COLORS_SETTINGS = ['#008080', '#A855F7', '#22C55E', '#F59E0B', '#EF4444', '#3B82F6', '#EC4899'];
